import { FaSass, FaCss3Alt, FaHtml5, FaNodeJs, FaGitAlt, FaPhp } from "react-icons/fa6";
	...
	return (<section className="main-content__skills">
		...
		<ul className="main-content__skills-wrapper">
			...
			<li className="main-content__skills-holder colored-tag PHP">
				<FaPhp className="main-content__skills-icon" />
			...
			<li className="main-content__skills-holder colored-tag BLUE">
